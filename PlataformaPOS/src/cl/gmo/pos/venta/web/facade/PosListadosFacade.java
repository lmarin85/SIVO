...
public class PosListadosFacade {
	...
	public static ListasTotalesDiaBean traeListasTotales(String fecha_ini,String fecha_fin,String local) {

		ListasTotalesDiaBean listasTotalesDia;
		try {
			ListadoTotalDiaDAOImpl ListadoTotalDiaDAO = new ListadoTotalDiaDAOImpl();
			listasTotalesDia=ListadoTotalDiaDAO.traeListasTotales(fecha_ini,fecha_fin,local);
		} catch (Exception e) {
			e.printStackTrace();
