...
public class ListadoTotalDiaDAOImpl implements ListadoTotalDiaDAO {
	...
	public ListasTotalesDiaBean traeListasTotales(String fecha_ini,String fecha_fin,String local) throws Exception {
		...
		try {
			...
			System.out.println("FECHA ==>"+fecha_ini+"<==>"+fecha_fin+"<===> LOCAL ==>"+local);
			con = ConexionFactory.INSTANCE.getConexion();
			cs = con.prepareCall("{ call SP_INFORME_SEL_VTA_POR_DIA_P(?,?,?,?,?,?,?,?,?)}");
			...
			rs3 = (ResultSet) cs.getObject(4);
			rs4 = (ResultSet) cs.getObject(5);
			rs5 = (ResultSet) cs.getObject(6);
			rs6 = (ResultSet) cs.getObject(7);
			rs7 = (ResultSet) cs.getObject(8);
			listasTotalesDia.setNumero_movimientos(cs.getInt(9));
				...
				if (codigo_0.equals(codigo_1)) {
					...
					else
					{
					 ...
					 // listaTMP.setCobrado(rs3.getString("IMPORTE"));
					  ...
					  //FECHA BOLETA 20180629
					  if(null == rs3.getString("FECHABOLETA") || "".equals(rs3.getString("FECHABOLETA"))){
						  listaTMP.setFechaBoleta(Constantes.STRING_BLANCO);  
					  }else{
						  listaTMP.setFechaBoleta(rs3.getString("FECHABOLETA"));
					  }
			  ...
			  {  
				...
				if (codigo_0.equals(codigo_1)) {
					...
					else
					{
					  ...
					  //FECHA BOLETA 20180629
					  if(null == rs4.getString("FECHABOLETA") || "".equals(rs4.getString("FECHABOLETA"))){
						  listaTMP.setFechaBoleta(Constantes.STRING_BLANCO);  
					  }else{
						  listaTMP.setFechaBoleta(rs4.getString("FECHABOLETA"));
					  }
				...
				else
				{
					...
					{
						Utils util = new Utils();
						ArrayList<BoletaBean> boletas = util.traeListaBoletasFechas(codigo_0, fecha_ini,fecha_fin);
					...
					cantidad_0 = rs4.getInt("CANTIDAD_PAGOS");
					  ...
					  if (cantidad_0 == 1) {
						  	Utils util = new Utils();
							ArrayList<BoletaBean> boletas_1 = util.traeListaBoletasFechas(codigo_0, fecha_ini,fecha_fin);
					  ...
					  if (listaTMP.getCobrado().equals(Constantes.STRING_CERO)) { listaTMP.setCobrado(Constantes.STRING_BLANCO);}
					  if (listaTMP.getTotal().equals(Constantes.STRING_CERO)) { listaTMP.setTotal(Constantes.STRING_BLANCO);}
					  if (listaTMP.getFechaBoleta().equals(Constantes.STRING_CERO)) { listaTMP.setFechaBoleta(Constantes.STRING_BLANCO);}
			...
			while (rs6.next())
            {
			  ...
			  //FECHA BOLETA 20180629
			  if(null == rs6.getString("FECHABOLETA") || "".equals(rs6.getString("FECHABOLETA"))){
				  listaTMP.setFechaBoleta(Constantes.STRING_BLANCO);  
			  }else{
				  listaTMP.setFechaBoleta(rs6.getString("FECHABOLETA"));
			  } 
			  //listaTMP.setFechaBoleta(rs6.getString("FECHABOLETA"));
			  ...
			  {  
				...
				if (codigo_0.equals(codigo_1)) {
					...
					else
					{
					  ...
					  //FECHA BOLETA 20180629
					  if(null == rs7.getString("FECHABOLETA") || "".equals(rs7.getString("FECHABOLETA"))){
						  listaTMP.setFechaBoleta(Constantes.STRING_BLANCO);  
					  }else{
						  listaTMP.setFechaBoleta(rs7.getString("FECHABOLETA"));
					  }
					 // listaTMP.setCobrado(rs3.getString("IMPORTE"));
