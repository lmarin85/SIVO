...
public MenuBean llenaMenu(String usuario) throws Exception {
	...
	public ArrayList<BoletaBean> traeListaBoletasFechas(String cdg_vta, String fecha_ini,String fecha_fin) throws Exception{
		...
		try{
			...
			conn = ConexionFactory.INSTANCE.getConexion();
            String sql = "{call SP_UTIL_SEL_BOLETAS_FECHAS_P(?,?,?,?)}";
            st = conn.prepareCall(sql);
