...
function calculaTotal() {
	...
	function cerrarPagina(){
		returnVal = document.getElementById("tiene_fomas_pago").value;
		window.parent.hidePopWin(true);
	}
	function inicio_pagina(){
		
		var respuesta_fpago_albaran = document.getElementById("respuesta_fpago_albaran").value;
	
		if("true"==respuesta_fpago_albaran){
			alert("El Pago fue eliminado correctamente");
			document.getElementById("respuesta_fpago_albaran").value="";
		}else if("false"==respuesta_fpago_albaran){
...
<body onload="if(history.length>0)history.go(+1);inicio_pagina()">
	...
	<html:form action="/SeleccionPago?method=eliminaFPagoBoleta" styleId="form1">
	...
	<html:hidden property="tiene_fomas_pago"  styleId="tiene_fomas_pago"/>		
	<html:hidden property="respuesta_fpago_albaran"  styleId="respuesta_fpago_albaran"/>		
				...
				<table width="100%" cellspacing="0" cellpadding="0">
	                ...
	                <bean:define id="fech_pago" type="String">
	                	<bean:write name="pagos" property="fecha" format="dd/MM/yyyy" />
	                        ...
	                        <tr >
	                            <td id="txt5" bgcolor="#c1c1c1" width="23%"><bean:write name="pagos" property="fecha" format="dd/MM/yyyy" /></td>
	                            <td id="txt5" bgcolor="#c1c1c1" width="23%" align="center"><bean:write name="pagos" property="detalle_forma_pago" /></td>
	                            ...
	                            <a href="#"  onclick="eliminar_pago_boleta_albaranes('${forma_pago}','${fech_pago}','<%=request.getContextPath()%>');" >
