				...
				*/				
			    ...
			    if(session.getAttribute(Constantes.STRING_TIPO_DOCUMENTO).toString().trim().equals("B")){
					if(!folio[0].equals("0")){	
						...
						/*if(local.equals("T002") || local.equals("S035") || local.equals("S064")){
		...
		*/
		...
		public ActionForward encargo_padre(ActionMapping mapping,
		            ...
		            HttpServletResponse response) throws Exception
	     {
			  ...
			  estado = helper.valida_cupon(formulario.getNumero_cupon().trim());
		            ...
		            HttpServletResponse response) throws Exception
		 {
			  ...
			  prod = helper.validaCristal(res[1],"C","81T","null","null","","",res[0],local,Double.parseDouble(res[3]), Double.parseDouble(res[4]), Integer.parseInt(res[5]));
